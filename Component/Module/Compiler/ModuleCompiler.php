...
namespace GravityCMS\Component\Module\Compiler;

use GravityCMS\Component\Field\DependencyInjection\Configuration\FieldsConfiguration;
use GravityCMS\Component\Menu\DependencyInjection\Configuration\MenuConfiguration;
use GravityCMS\Component\Module\Compiler\Exception\ModuleConfigNotFound;
 ...
 *
 * @package Nefarian\CmsBundle\Module
...
class ModuleCompiler
{
    ...
    {
        $configuration = new FieldsConfiguration();
    ...
    {
//        $configuration = new TemplatingConfiguration();
...
//        return $this->configs[self::CONFIG_TEMPLATING] = $config;
     ...
     * Get a config array
     *
     * @param string $name One of the ModuleCompiler::CONFIG_* constants
     *
     * @return array
     */

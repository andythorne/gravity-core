...
use GravityCMS\CoreBundle\Entity\Repository\RouteRepository;
...
class GravityRouteProvider implements RouteProviderInterface
{
    ...
    function __construct(EntityManager $entityManager)
    {
        ...
        $this->routeRepository = $entityManager->getRepository('GravityCMSCoreBundle:Route');
    }
    ...
    public function getRouteCollectionForRequest(Request $request)
    {
        ...
        /** @var \GravityCMS\CoreBundle\Model\Route[] $routes */

...
namespace GravityCMS\Component\Assetic\Filter;
...
class ReactJsxFilter extends BaseNodeFilter
{
    ...
    public function filterLoad(AssetInterface $asset)
    {
        ...
        $inputDir = self::createThrowAwayDirectory('jsx_in');
        $inputFile = $inputDir.DIRECTORY_SEPARATOR.'asset.js';
        $outputDir = self::createThrowAwayDirectory('jsx_out');
    ...
    {
        $directory = realpath(sys_get_temp_dir()).DIRECTORY_SEPARATOR.uniqid('assetic_'.$prefix);
